...
const LoadingFallback = ({ message }: { message: string }) => (
  <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
    <div className="text-center space-y-4">
      <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-lumino-purple-start mx-auto"></div>
...
function AppContent() {
  ...
  if (currentScreen === 'roi-analysis') {
    return (
      <Suspense fallback={<LoadingFallback message="Učitavanje ROI analize..." />}>
  ...
  if (currentScreen === 'chart-generator') {
    return (
      <Suspense fallback={<LoadingFallback message="Učitavanje analize proizvodnje..." />}>
  ...
  if (currentScreen === 'final-proposal') {
    return (
      <Suspense fallback={<LoadingFallback message="Učitavanje konačne ponude..." />}>
        <FinalProposalScreen 
  ...
  if (currentScreen === 'system-specification') {
    return (
      <Suspense fallback={<LoadingFallback message="Učitavanje specifikacije sistema..." />}>
